	...
	mtr_t*		mtr)	/*!< in/out: mini-transaction */
{
	...
	if (zip_size) {
		// TODO :: There might be some confliction, Need double check
		//optimal_page_size =
...
btr_defragment_init()
{
	...
	fprintf(stderr, "init interval to %llu\n", srv_defragment_interval);
...
btr_defragment_get_item()
{
	...
	static list< btr_defragment_item_t* >::iterator iter = btr_defragment_wq.begin();
