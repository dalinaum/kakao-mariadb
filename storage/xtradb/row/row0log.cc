...
write_failed:
	...
	onlineddl_rowlog_pct_used = (log->tail.total * 10000) / srv_online_max_size; /* 10000 means 100.00%, 4525 means 45.25% */
	/**
	 * Debug for Matt
	 */
	// fprintf(stderr, ">> DEBUG :: online ddl change buffer usage : Current:%llu , Total:%llu, Max:%llu \n", size, log->tail.total, srv_online_max_size);
}
